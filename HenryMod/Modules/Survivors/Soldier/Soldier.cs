...
{
    internal class Soldier : SurvivorBase
    {
        internal override string bodyName { get; set; } = "Soldier";
        ...
        public static SkillDef damageBannerSkillDef;
        public static SkillDef healBannerSkillDef;
        public static SkillDef tankBannerSkillDef;
        ...
        internal override void InitializeSkills()
        {
            ...
            SkillDef fastRocketSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
            ...
            SkillDef healRocketSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
            ...
            SkillDef bisonSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                ...
                skillIcon = Modules.Assets.mainAssetBundle.LoadAsset<Sprite>("texSecondaryIcon"),
                activationState = new EntityStates.SerializableEntityStateType(typeof(SkillStates.ShootBison)),
                activationStateMachineName = "Weapon",
                baseMaxStock = 4,
                baseRechargeInterval = 2.25f,
                beginSkillCooldownOnSkillEnd = true,
                canceledFromSprinting = false,
                forceSprintDuringState = false,
                fullRestockOnAssign = true,
            ...
            damageBannerSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
                skillName = prefix + "UTILITY_DAMAGE_NAME",
                skillNameToken = prefix + "UTILITY_DAMAGE_NAME",
                skillDescriptionToken = prefix + "UTILITY_DAMAGE_DESCRIPTION",
            ...
            healBannerSkillDef = Modules.Skills.CreateSkillDef(new SkillDefInfo
            {
            ...
            Modules.Skills.AddUtilitySkills(bodyPrefab, new SkillDef[] { damageBannerSkillDef, healBannerSkillDef });
            #endregion
        ...
        internal override void InitializeSkins()
        {
            ...
            #region DefaultSkin
            SkinDef defaultSkin = Modules.Skins.CreateSkinDef(HenryPlugin.developerPrefix + "_SAXTONHALE_BODY_DEFAULT_SKIN_NAME",
            ...
            SkinDef masterySkin = Modules.Skins.CreateSkinDef(HenryPlugin.developerPrefix + "_SAXTONHALE_BODY_MASTERY_SKIN_NAME",
